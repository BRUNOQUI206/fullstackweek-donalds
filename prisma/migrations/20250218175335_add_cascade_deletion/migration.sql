...
-- DropForeignKey
ALTER TABLE "Order" DROP CONSTRAINT "Order_resruantId_fkey";
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_resruantId_fkey" FOREIGN KEY ("resruantId") REFERENCES "Restaurant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
