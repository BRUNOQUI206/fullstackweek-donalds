...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_resruantId_fkey" FOREIGN KEY ("resruantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
